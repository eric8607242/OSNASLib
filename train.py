...
if __name__ == "__main__":
    ...
    model = Model(macro_cfg, micro_cfg, architecture, args.classes, args.dataset)
    ...
    trainer = Trainer(criterion, optimizer, lr_scheduler, writer, logger, args.device, "evaluate", args, start_epoch=start_epoch)

...
if __name__ == "__main__":
    ...
    training_strategy = TrainingStrategy(
        args.sample_strategy, len(micro_cfg), len(
            macro_cfg["search"]), supernet)
    ...
    if args.resume:
        start_epoch = resume_checkpoint(
            supernet, args.resume, optimizer, lr_scheduler)
        logger.info(
    ...
    best_architecture, best_architecture_hc, best_architecture_top1 = search_strategy.search(
